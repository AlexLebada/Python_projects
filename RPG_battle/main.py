...
from interface.gui import gui_status
...
#Instantiate characters & characteristics
...
enemy2 = Person("Magus:", 18000,721, 545, 25, enemy_spells, []) # enemy has no magic
...
while running:
    ...
    # player attack: physical/magical/item
    for player in players:
        ...
        if index == 0:
            ...
            print("You attacked " + enemies[enemy].name + " for", dmg, "points of dmg")
    ...
    # enemy attack
    for enemy in enemies:
        # enemy choose action to take
        enemy_choice = random.randrange(0, 2)

        if enemy_choice == 0:
            # enemy choose target to attack
            target = random.randrange(0, 3)
            enemy_dmg = enemies[0].generate_damage()
            # target a player randomly
